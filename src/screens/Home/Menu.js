      ...
      <View>
        ...
        <ScrollView horizontal>
          <View style={{height: 50, flexDirection: 'row'}}>
            <TouchableOpacity
              style={[styles.tabBar, {borderBottomWidth: 2}]}
              onPress={() =>
                this.refs._contentScroll.scrollTo({x: 0, y: 0, animated: true})
              }>
            ...
            <TouchableOpacity
              style={[styles.tabBar, {borderBottomWidth: 0}]} // 212
              onPress={() =>
            ...
            <TouchableOpacity
              style={[styles.tabBar, {borderBottomWidth: 0}]}
              onPress={() =>
                this.refs._contentScroll.scrollTo({
                  x: 0,
                  y: 122 + 212,
              ...
              <View
                ...
                <View style={{height: '100%', width: '55%'}}>
                  <Text style={{fontWeight: 'bold'}}>
                    Raisin Delight Frappe
                  </Text>
                  <Text numberOfLines={3}>
                    a timeless classic. A sweet, creamy, rich, flavourful
                    experience of vanilla cream and juicy ripe raisins with a
                    hint of warmth
                  </Text>
                </View>
